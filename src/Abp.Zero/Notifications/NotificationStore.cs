...
namespace Abp.Notifications
{
    ...
    public class NotificationStore : INotificationStore, ITransientDependency
    {
        ...
        [UnitOfWork]
        protected virtual Task<List<NotificationSubscriptionInfo>> GetSubscriptionsAsync(Guid? tenantId, string notificationName, string entityTypeName, string entityId)
        {
