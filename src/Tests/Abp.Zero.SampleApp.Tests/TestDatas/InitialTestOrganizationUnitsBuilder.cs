...
namespace Abp.Zero.SampleApp.Tests.TestDatas
{
    ...
    public class InitialTestOrganizationUnitsBuilder
    {
        ...
        {
            var ou1 = CreateOU("OU1", OrganizationUnit.CreateUnitCode(1));
            var ou11 = CreateOU("OU11", OrganizationUnit.CreateUnitCode(1, 1), ou1.Id);
            var ou111 = CreateOU("OU111", OrganizationUnit.CreateUnitCode(1, 1, 1), ou11.Id);
            var ou112 = CreateOU("OU112", OrganizationUnit.CreateUnitCode(1, 1, 2), ou11.Id);
            var ou12 = CreateOU("OU12", OrganizationUnit.CreateUnitCode(1, 2), ou1.Id);
            var ou2 = CreateOU("OU2", OrganizationUnit.CreateUnitCode(2));
            var ou21 = CreateOU("OU21", OrganizationUnit.CreateUnitCode(2, 1), ou2.Id);
        }
